            ...
            {studentInfo && (
                <Modal isOpen={isInfoModalOpen} onClose={handleCloseInfoModal} width="1000px">
                    <div>
                        ...
                        <div>Lesson
                            Type: {studentInfo.lessonDescriptor ? studentInfo.lessonDescriptor.type : "None"}</div>
                        <div>Mentor: {studentInfo.mentor ? studentInfo.mentor.name + " " + studentInfo.mentor.lastName : "None"}</div>
                        <YearCalendar year={2025} lessonDescriptor={studentInfo.lessonDescriptor}></YearCalendar>
                    </div>
                </Modal>
            )}
        </div>
